...
struct ErrorMessage errors[NUM_OF_ERRORS] = {
  ...
  {ERR_NORETURNFUNCTION, "Need an assignment statement of function."},
  ...
  {ERR_EXPECTED_ENDSTRING, "End of string expected!"},
  {ERR_STRING_EXCESS_INIT, "String excess init!"},
  {ERR_OPERATOR_ASSIGN_WITH_CHAROFSTRING, "Operator assign with char of string"},
  {ERR_INVALIDCHARCONSTANT, "Invalid const char!"},
  {ERR_FOR_INDEX_CAN_NOT_FLOAT, "For index can not float"}
};
